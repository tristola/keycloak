...
public abstract class AbstractResourceServerTest extends AbstractKeycloakTest {
    ...
    protected AuthorizationResponse authorize(String userName, String password, PermissionRequest... permissions) {
        return authorize(userName, password, null, null, null, permissions);
    }
    ...
    protected AuthorizationResponse authorize(String userName, String password, String resourceName, String[] scopeNames, String[] additionalScopes, String rpt, String accessToken) {
        return authorize(userName, password, additionalScopes, rpt, accessToken, new PermissionRequest(resourceName, new HashSet<>(Arrays.asList(scopeNames))));
    }

    protected AuthorizationResponse authorize(String userName, String password, String[] additionalScopes, String rpt, String accessToken, PermissionRequest... permissions) {
